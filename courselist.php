			...
			<div class="row course_boxes">
				<?php
					...
					<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_author_name"><?php echo "Thầy giáo : Nguyễn Công Hoan </br>"; ?><span></span></div>
							<div class="course_author_name"><?php echo "Số lượng bài học + bài kiểm tra : ".$number_1['count(MaChiTiet)']; ?><span></span></div>
						</div>
					<?php
				...
				<div class="card-body text-center">
						<div class="card-title"><a href="lesson_details.php?ct=<?php echo $number['MaChiTiet']; ?>"><?php echo $number['TenCongThuc']; ?></a></div>
				</div>
				<?php
				} ?>
			</div>
